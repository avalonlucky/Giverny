...
export const agentCapabilityRegistry = {
  ...
  generate_settlement_receipt: defineCapability({
    ...
    policy: { risk: 'write', deterministic: true, source: 'd1', scopes: ['finance:write'], roles: settlementReceiptRoles, confirmation: 'none', audit: 'business', auditEvent: 'agent_generate_settlement_receipt' },
