...
export type RecursivePartialNull<T> = MovedRecursivePartialNull<T>
    ...
    env?: Record<string, string | undefined>
      tags?: Record<string, string>
        ...
        async OptimizeTaskText(
        payload_json: string,
        __baml_options__?: BamlCallOptions<never>
        ): Promise<types.TextAssistantOutput> {
          try {
          ...
          const __stream__ = this.stream.OptimizeTaskText(
          payload_json,
          __baml_options__
          );
          ...
          const __env__: Record<string, string> = Object.fromEntries(
            ...
            return __raw__.parsed(false) as types.TextAssistantOutput
            } catch (error) {
            throw toBamlError(error);
            }
            }
            
        async SuggestHourEstimate(
        payload_json: string,
        __baml_options__?: BamlCallOptions<never>
        ): Promise<types.HourEstimateOutput> {
          try {
          const __options__ = { ...this.bamlOptions, ...(__baml_options__ || {}) }
          const __signal__ = __options__.signal;
          ...
          // Check if onTick is provided - route through streaming if so
          if (__options__.onTick) {
          const __stream__ = this.stream.SuggestHourEstimate(
          payload_json,
          __baml_options__
          );
          ...
          const __env__: Record<string, string> = Object.fromEntries(
            ...
            return __raw__.parsed(false) as types.HourEstimateOutput
            } catch (error) {
            throw toBamlError(error);
            }
            }
            
        async SuggestTaskAssistant(
        payload_json: string,
        __baml_options__?: BamlCallOptions<never>
        ): Promise<types.TaskAssistantOutput> {
          try {
          const __options__ = { ...this.bamlOptions, ...(__baml_options__ || {}) }
          const __signal__ = __options__.signal;
          ...
          // Check if onTick is provided - route through streaming if so
          if (__options__.onTick) {
          const __stream__ = this.stream.SuggestTaskAssistant(
          payload_json,
          __baml_options__
          );
          ...
          const __env__: Record<string, string> = Object.fromEntries(
            ...
            return __raw__.parsed(false) as types.TaskAssistantOutput
            } catch (error) {
            throw toBamlError(error);
            }
            }
            ...
            payload_json: string,
            __baml_options__?: BamlCallOptions<never>
            ): BamlStream<partial_types.TextAssistantOutput, types.TextAssistantOutput>
              {
              try {
              const __options__ = { ...this.bamlOptions, ...(__baml_options__ || {}) }
              const __signal__ = __options__.signal;
              ...
              console.error("Error in onTick callback for OptimizeTaskText", error);
              }
              }
              };
              }
              ...
              const __env__: Record<string, string> = Object.fromEntries(
                ...
                return new BamlStream<partial_types.TextAssistantOutput, types.TextAssistantOutput>(
                  __raw__,
                  (a): partial_types.TextAssistantOutput => a,
                  (a): types.TextAssistantOutput => a,
                  this.ctxManager.cloneContext(),
                  __options__.signal,
                  )
                  } catch (error) {
            ...
            payload_json: string,
            __baml_options__?: BamlCallOptions<never>
            ): BamlStream<partial_types.HourEstimateOutput, types.HourEstimateOutput>
              {
              try {
              const __options__ = { ...this.bamlOptions, ...(__baml_options__ || {}) }
              const __signal__ = __options__.signal;
              ...
              console.error("Error in onTick callback for SuggestHourEstimate", error);
              }
              }
              };
              }
              ...
              const __env__: Record<string, string> = Object.fromEntries(
                ...
                return new BamlStream<partial_types.HourEstimateOutput, types.HourEstimateOutput>(
                  __raw__,
                  (a): partial_types.HourEstimateOutput => a,
                  (a): types.HourEstimateOutput => a,
                  this.ctxManager.cloneContext(),
                  __options__.signal,
                  )
                  } catch (error) {
            ...
            payload_json: string,
            __baml_options__?: BamlCallOptions<never>
            ): BamlStream<partial_types.TaskAssistantOutput, types.TaskAssistantOutput>
              {
              try {
              const __options__ = { ...this.bamlOptions, ...(__baml_options__ || {}) }
              const __signal__ = __options__.signal;
              ...
              console.error("Error in onTick callback for SuggestTaskAssistant", error);
              }
              }
              };
              }
              ...
              const __env__: Record<string, string> = Object.fromEntries(
                ...
                return new BamlStream<partial_types.TaskAssistantOutput, types.TaskAssistantOutput>(
                  __raw__,
                  (a): partial_types.TaskAssistantOutput => a,
                  (a): types.TaskAssistantOutput => a,
                  this.ctxManager.cloneContext(),
                  __options__.signal,
                  )
                  } catch (error) {
