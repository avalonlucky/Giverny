import { Fragment, lazy, memo, Suspense, type ClipboardEvent as ReactClipboardEvent, type CSSProperties, type ReactNode, useCallback, useEffect, useMemo, useRef, useState } from 'react'
...
import { datePart, formatMonthDay, isoDate, isoDateTime, localDateFromIsoDate, monthPart, pad, planDateTimeFromMinuteStamp } from './lib/dateTime'
          ...
          canSeeFull || isClient ? (
            <Suspense fallback={<p className="calendar-empty-hint">正在载入结算回单…</p>}>
              <ReportsView
                ...
                onNotify={notify}
                PlanDateTimeField={PlanDateTimeField}
              />
            </Suspense>
          ) : (
            adminOnlyPanel
