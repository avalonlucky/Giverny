...
export const productKnowledgeDocuments: ProductKnowledgeDocument[] = [
  {
    ...
    "content": "最新说明：工作助手回答 Giverny 的主题、模型设置、版本更新、品牌名称和产品规则时，会先查询官方产品知识；规划模型漏掉工具调用时，编排层会自动补查。产品知识没有记录的内容会明确说明，不允许模型凭记忆补写。每次构建会自动把本手册、Agent 运营手册和完整 `CHANGELOG` 生成检索索引，因此手册随代码发布后会同步成为 Agent 知识库；当前也已收录作者确认的 Giverny 品牌故事。\n\n> 网址：**https://mayeai.com**\n> 这份手册写给日常使用者（你自己），每次功能更新都会同步到文末的「更新记录」。\n> 技术细节和接口文档见 `handoff/HANDOFF.md`，开发改动明细见 `CHANGELOG.md`。\n\n---"
  },
  {
    "id": "使用手册.md#2",
    "sourcePath": "使用手册.md",
