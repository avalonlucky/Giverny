...
async function adkResponse(payload) {
  ...
  const base = {
    ...
    orchestration: { engine: 'google-adk-2', status: 'answered', path: ['scope_supervisor', 'response_synthesizer', 'evidence_auditor'], specialists: [], evidenceCount: 1, provider: String(selectedModel.provider), model: String(selectedModel.model), modelPolicy: 'exact-selected-model-no-fallback', modelCallLimit: 9 },
